...
- `/?present=1` hides the controls and autoplays with captions, for screen recordings.
...
- `data/presets.ts` holds the four requests, their key memories and the illustrative replies.
